  ...
  return (
    <div className="flex justify-center ">
      <div className="p-4 min-w-[500px] ">
        ...
        <div className="overflow-y-auto max-h-[500px] rounded-lg shadow">
          <table className="min-w-[800px] bg-white text-black rounded">
              ...
              {lands.length > 0 ? (
                lands.map((land) => (
                  <tr key={land._id} className="text-center">
                    ...
                    <td className="p-2">{land.status}</td>
                    <td className="p-2 flex justify-center gap-x-4 space-x-2">
                      <Link to={`/dashboard/edit-land/${land._id}`} className="text-xl text-blue-600">
                        <MdEditSquare />
                      </Link>
                      <button onClick={() => deleteLand(land._id)} className="text-xl text-red-500 hover:opacity-75">
                        <RiDeleteBin6Fill />
                      </button>
                    </td>
                  </tr>
                ...
                <tr>
                  <td colSpan="5" className="text-center p-4">No lands available.</td>
                </tr>
              )}
            </tbody>
          </table>
